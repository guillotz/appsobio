package com.andromeda.latam.sobio.component.camera2;
...
public class Camera2Helper {
    ...
    private com.andromeda.latam.sobio.component.camera2.Camera2Listener camera2Listener;
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            mPreviewRequestBuilder.set(CaptureRequest.NOISE_REDUCTION_MODE, CaptureRequest.NOISE_REDUCTION_MODE_FAST);
    ...
    public static final class Builder {
        ...
        public Builder cameraListener(com.andromeda.latam.sobio.component.camera2.Camera2Listener val) {
            camera2Listener = val;
            return this;
        }
